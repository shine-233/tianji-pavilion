...
/** 场景化台词：各殿当值道长的行话 */
export const TAO_TIPS: Record<string, string[]> = {
  qingxuan: ['前殿后山十七进殿宇，迷路就点右上角地图。', '香客常问哪页最灵——顺眼的那个就是。'],
  danxia: ['翻牌之前先深呼吸，时辰别报错。', '权重都摆在明面上，分数不服可以来挑刺。'],
  xinglan: ['点宫位看详情，三方四正的线会自己亮。 夜里排星最准，白天凑合。'],
  suwen: ['拖一拖，五行会跟着你转。', '缺哪个五行，山就矮一截，很诚实。'],
  yunji: ['七部古书我全扫过一遍，密度图不会骗人。', '查术语点金色的字就行。'],
  shuanghua: ['格局五书互证，孤证不入册。 剑是桃木的，规矩是铁的。'],
  shouzhuo: ['七百九十九条，条条有出处。', '发现规则写错了？那可是大事，快说。'],
  shiyi: ['两千多个命例，按置信度筛着看不累。', '旧案重读，常有新味道。'],
  lingshi: ['铜钱落定前，心里只装一件事。 三枚背是老阳，记牢口诀不慌。'],
  meixue: ['签是死的，解签的心是活的。', '一天一支就好，贪签不灵。'],
}
