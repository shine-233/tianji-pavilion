  ...
  <main class="page">
    <section class="hero card hoverable">
      ...
      <div class="hero-wheel" aria-hidden="true">
        ...
        <div v-for="(e, i) in SHENG_ORDER" :key="e" class="orbit-ele" :class="[`ele-${e}`, `bg-${e}`, { hov: hoverEle === e }]" :style="{ '--i': i }" @pointerdown="lastPtr = $event.pointerType" @mouseenter="hoverEnter(e)" @mouseleave="hoverEle = null" @click="hoverEle = hoverEle === e ? null : e; sfx.blip()">
          {{ e }}
        </div>
